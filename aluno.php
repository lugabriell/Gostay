    ...
    <div class="kpi-card" style="width: 100%;">
        ...
        <div class="content-grid">
            ...
            <div class="content-card">
                <div class="content-card-header">
                    <h3 class="content-card-title">Professores deste Aluno</h3>
            ...
            </div> <!-- ✅ agora fecha no lugar certo -->



            <div class="content-card">
                <div class="content-card-header">
                    <h3 class="content-card-title">Aulas deste Aluno</h3>
        ...
        <div class="table-container">
            <div class="table-header">
                <h3 class="table-title">Cursos deste Aluno</h3>
