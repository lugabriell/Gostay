...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav>
            <ul class="nav-menu">
                ...
                <li class="nav-item">
                    <a href="alunosadm.php" class="nav-link active">
                        <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    <main class="main-content">
        ...
        <div class="page-header">
            ...
            <p class="page-subtitle">Gerencie todos os alunos da plataforma</p>
        </div>
        ...
        <div class="action-buttons">
            <form action="admre3.php" method="post">
                <button type="submit" name="aluno" value="aluno" class="btn btn-primary">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <button type="submit" name="curso" value="curso" class="btn btn-primary">
                ...
                <button type="submit" name="cursos" value="cursos" class="btn btn-secondary">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <div class="content-grid">
            ...
            <div class="content-card">
                ...
                <?php 
                    $numteste = 0;
                    while($numteste <=3 and $dadosprofessor = mysqli_fetch_assoc($resultprofessor)):
            ...
            <div class="content-card">
                ...
                <?php 
                $numaula = 0;
                while(($dadosaula = mysqli_fetch_assoc($resultaula)) && $numaula < 4):
                ?>
        ...
        <div class="table-container">
            <div class="table-header">
                <h3 class="table-title">Todos os Alunos</h3>
                ...
                <tbody>
                    <?php
                        ...
                        while($dadoscursos = mysqli_fetch_assoc($resultcurso)):
                             ...
                             if($dadoscursos['autenticado'] === 'sim'){
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="table-actions">
                                ...
                                <a href='delete/deletealuno.php?id=<?= $dadoscursos['id'] ?>' class="action-btn" title="Excluir">
                                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
