...
<body>
  ...
  <div class="container" role="region" aria-label="Formulário de contato responsivo">
    <section class="hero" aria-hidden="false">
      ...
      <p>Preencha os dados para se tornar um professor</p>

      <div class="accent-pill" aria-hidden="true">✓ Campos essenciais</div>
    </section>

    <form enctype="multipart/form-data" class="side" action="creates/createprof.php" method="POST" id="contactForm" novalidate>
      <div>
      ...
      <div>
        <div>
          ...
          <input type="text" name="formacao" id="formacao" required placeholder="Sua Formação aqui" />
        </div>
      </div>
      <div>
        <div>
          <label for="bio">Bio</label>
          <input type="text" name="bio" id="bio" required placeholder="Sua Bio aqui" />
        </div>
      </div>
      <div>
        <div>
