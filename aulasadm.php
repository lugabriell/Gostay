            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo htmlspecialchars($dadoscursos['duracao']);  ?></td>
                        <td><span class="badge <?php echo htmlspecialchars($badgeclass); ?>"><?php echo htmlspecialchars($dadoscursos['statusaula']);?></span></td>
                        <td><?php echo htmlspecialchars($dadoscursos['descricao']);?></td>
                        <td>
                            <div class="table-actions">
                                <a href='aula.php?id=<?= htmlspecialchars($dadoscursos['id']) ?>' class="action-btn" title="Editar">
                                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
