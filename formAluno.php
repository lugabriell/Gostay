...
<body>
  ...
  <div class="container" role="region" aria-label="Formulário de contato responsivo">
    ...
    <form enctype="multipart/form-data" class="side" action="creates/createaluno.php" method="POST" id="contactForm" novalidate>
      <div>
      ...
      <div class="row">
        <div class="field">
          ...
          <input id="email" name="email"  minlength="1" maxlength="250" type="email" required placeholder="seu@exemplo.com" />
        </div>
        <div class="field">
          <label for="telefone">Telefone</label>
          <input id="telefone" name="telefone"  minlength="1" maxlength="250" type="tel" required placeholder="(XX) XXXXX-XXXX" />
        </div>
      </div>
      <div>
        <div>
      ...
      <div><div>
        ...
        <input id="datanas" name="datanas" type="date" required />
      </div></div>
      <div>
        <div>
          <label for="formacao">Formação</label>
          <input type="text" name="formacao"  minlength="1" maxlength="250" id="formacao" required placeholder="Sua formação aqui" />
        </div>
        <?php 
