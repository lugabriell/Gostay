...
<div class="kpi-grid">
    <div class="kpi-card" style="width: 100%;">
        <div class="kpi-header" style="align-items: center; gap: 20px;">
            ...
            <div>
                <img src="creates/<?php echo(htmlspecialchars($dadosinfo['ftperfil'])); ?>" 
                     alt="Avatar" 
            ...
            <div>
                ...
                <div class="kpi-label" style="margin-top:8px;">
                    <strong>Formação:</strong> <?php echo(htmlspecialchars($dadosinfo['formacao'])); ?>
                </div>

                <div class="kpi-label" style="margin-top:4px;">
                    <strong>Email:</strong> <?php echo(htmlspecialchars($dadosinfo['email'])); ?>
                </div>
                <div class="kpi-label" style="margin-top:4px;">
                    <strong>Data Cadastro:</strong> <?php echo(htmlspecialchars($dadosinfo['datacadastro'])); ?>
                </div>
                <div class="kpi-label" style="margin-top:4px;">
        ...
        <div class="action-buttons">
            <form action="admre6.php" method="post">
                ...
                <button type="submit" name="curso" value="<?php echo(htmlspecialchars($idinfo)); ?>" class="btn btn-primary">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <button type="submit" name="aula" value="<?php echo(htmlspecialchars($idinfo)); ?>" class="btn btn-primary">
                ...
                <button type="submit" name="professor" value="<?php echo(htmlspecialchars($idinfo)); ?>" class="btn btn-secondary">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                ?>
                    ...
                    <div class="course-list-item">
                        ...
                        <div class="course-info">
                            ...
                            <td> 
                                <a href='editaraula.php?id=<?= htmlspecialchars($dadosaula['id']) ?>' class="action-btn" title="Editar">
                                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                        <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path>
                                        <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path>
                                    </svg>
                                </a>
                            <form action="delete/deleteaula.php" method="POST" style="display:inline;">
                                <input type="hidden" name="id" value="<?= htmlspecialchars($dadosaula['id']) ?>">
            ...
            <table>
                ...
                <tbody>
                    ...
                    while($dadoscursoaluno = mysqli_fetch_assoc($resultcursoaluno)):
                        $idcurso = (int) $dadoscursoaluno['id'];
                    ...
                    <tr>
                        ...
                        <td><span class="badge <?php echo htmlspecialchars($badgeclass); ?>"><?php echo htmlspecialchars($dadoscursoaluno['statuscurso']);?></span></td>
                        ...
                        <td>
                            <div class="table-actions">
                               ...
                               <form action="delete/deletecurso.php" method="POST" style="display:inline;">
                                    <input type="hidden" name="id" value="<?= htmlspecialchars($dadoscursos['id']) ?>">
                                    <input type="hidden" name="token" value="<?= htmlspecialchars($_SESSION['tokenadm']) ?>">
                                    <button type="submit" class="action-btn" title="Excluir" onclick="return confirm('Tem certeza que deseja excluir este curso?');">
                                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                            <polyline points="3 6 5 6 21 6"></polyline>
                                            <path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path>
                                        </svg>
