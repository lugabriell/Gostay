<?php
    ...
    for($i = 0; $i< $qtdcurso; $i++){
        ...
        while($rowcursoaluno = $result3->fetch_assoc()){
            $idaluno[] = $rowcursoaluno['idaluno'];
            $statusa[] = $rowcursoaluno['statusa'];
            $idcurso[] = $rowcursoaluno['idcurso'];
        }
    }
...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav>
            <ul class="nav-menu">
                ...
                <li class="nav-item">
                    <a href="homeprof.php" class="nav-link active">
    ...
    <main class="main-content">
        ...
        <div class="page-header">
            ...
            <p class="page-subtitle">Gerencie todos os seus alunos da plataforma</p>
        </div>
        ...
        <div class="table-container">
            <div class="table-header">
                <h3 class="table-title">Os seus Alunos</h3>
            ...
            <table>
                ...
                <tbody>
                    <?php
                        $qtdidaluno = count($idaluno);
                       
                        for($l = 0;$l < $qtdidaluno; $l++):
                            $stmt4 = $conexao->prepare("SELECT * FROM alunos WHERE id = ?");
                            $stmt4->bind_param("i", $idaluno[$l] );
                            $stmt4->execute();
                            $result4 = $stmt4->get_result();
                            
                            while($dadosalunos = $result4->fetch_assoc()):
