...
<body>
    ...
    <div class="form-container">
        ...
        <!-- Formulário -->
        <form action="edit/editcurso.php" method="POST">
                ...
                <div class="radio-group">
                    <label class="radio-label">
                        <input 
                            ...
                            value="ativo"  
                            required
                            <?php if ($dadoscurso['statuscurso'] == 'ativo') { echo 'checked'; } ?>
                        >
                        <span>Ativo</span>
                    </label>
              ...
              <?php while ($dadoscategoria = mysqli_fetch_assoc($resultcategoria)): ?>
                          <label class="radio-label">
                              <input
                                  ...
                                  required
                                  <?= ($dadoscategoria['id'] == $dadoscurso['idcategoria']) ? 'checked' : '' ?>
                              >
                ...
                <div class="radio-group">
                    <label class="radio-label">
                        <input 
                            ...
                            value="iniciante"  
                            required
                            <?php if ($dadoscurso['nivel'] == 'iniciante') { echo 'checked'; } ?>
                        >
                        <span>Iniciante</span>
                    </label>
                    ...
                    <label class="radio-label">
                        <input 
                            ...
                            name="nivel" 
                            value="intermediário"
                            <?php if ($dadoscurso['nivel'] == 'intermediário') { echo 'checked'; } ?>
                        >
                    ...
                    <label class="radio-label">
                        <input 
                            ...
                            name="nivel" 
                            value="avancado"
                            <?php if ($dadoscurso['nivel'] == 'avancado') { echo 'checked'; } ?>
                        >
                        <span>Avançado</span>
                    </label>
