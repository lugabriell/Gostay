    ...
    <main class="main-content">
        ...
        <div class="action-buttons">
            <form action="admre.php" method="post">
                ...
                <button type="submit" name="categoria" value="categoria" class="btn btn-primary">
                ...
                <button type="submit" name="categorias" value="categorias" class="btn btn-secondary">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <?php
                        ...
                        while($dadoscursos = mysqli_fetch_assoc($resultcurso)):
                            ...
                            $dadoscategoria2 = mysqli_fetch_assoc($resultcategoria2);
                             if($dadoscursos['statuscurso'] === 'ativo'){
