...
<body>
  ...
  <div id="player" class="is-paused">
    ...
    <video id="video" preload="metadata">
      ...
      <source src="creates/assets/69971d0f26647.mp4" type="video/mp4"/>
    ...
    <div class="top-bar">
      <a href="streamvibe-detalhe.html" class="back-btn">
      ...
      <div class="top-titles">
        <div class="top-course-name">Design de Interfaces Modernas</div>
        <div class="top-lesson-name">Aula 03 — Teoria das Cores e Paletas Modernas</div>
      </div>
    </div>
    ...
    <div class="next-card" id="next-card">
      ...
      <img class="next-card-thumb" src="https://picsum.photos/seed/next-lesson/480/270" alt="Próxima aula"/>
      <div class="next-card-body">
        <div class="next-card-label">
          <svg width="10" height="10" viewBox="0 0 24 24" fill="currentColor"><path d="M8 5v14l11-7z"/></svg>
          Próxima aula
        </div>
        <div class="next-card-title">Aula 04 — Grid Systems e Layout Responsivo</div>
        <div class="next-card-sub">Módulo 2 · 52 min</div>
        <div class="next-card-actions">
          <button class="next-play-btn" id="next-play-btn">
            <svg width="13" height="13" fill="currentColor" viewBox="0 0 24 24"><path d="M8 5v14l11-7z"/></svg>
            Assistir agora
          </button>
          <button class="next-dismiss-btn" id="next-dismiss-btn">Ignorar</button>
        </div>
      </div>
    </div>
  ...
  <script>
    ...
    nextPlayBtn.addEventListener('click', () => {
      ...
      alert('Navegando para a próxima aula…');
    });

    video.addEventListener('ended', () => {
      if (autoplayOn && !nextCardDismissed) {
        alert('Próxima aula carregando…');
      }
    });
